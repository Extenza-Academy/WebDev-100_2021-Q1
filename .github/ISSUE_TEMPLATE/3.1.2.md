...
![explorer in VS Code](https://github.com/Extenza-Academy/WebDev-100_2021-Q1/blob/main/lessons/3-terrarium/1-intro-to-html/images/vs-code-index.png)
...
Create a folder in your app called `images` and in that, add all the images in the [source code folder](https://github.com/Extenza-Academy/WebDev-100_2021-Q1/tree/main/lessons/3-terrarium/solution/images); (there are 14 images of plants).
